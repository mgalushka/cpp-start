...
//template learning::Holder<int>::Holder(const int& val);
//template learning::Holder<int>::~Holder();
...
TEST(HolderDungling, holder) {
  ...
  // try to mess up with poiter - but actually any pointer returned from function is returned via copy
